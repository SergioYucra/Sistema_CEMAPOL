	 	...
	 	<table id="datatable" class="table table-hover table-condensed table-bordered">
		  ...
		  <tbody>
		  	...
		  	while ($row = mysqli_fetch_array($resultado_reg)) { ?>
			      ...
			      <td>			      	
			      	<a href="../historial/pdf_inventario.php?idI= <?php echo $row['idinventario'] ?> " class="btn btn-secondary" title="Generar PDF">
				      <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
				    </a>
				    <a href="../historial/ver_inventario.php?idI= <?php echo $row['idinventario'] ?> " class="btn btn-info" title="Ver Registro">
			      		<i class="fa fa-eye" aria-hidden="true"></i>
			      	</a>
			      	<a href="#" onclick="borrarInventario(<?php echo $row['idinventario']?>)" class="btn btn-danger" title="Borra Registro">
