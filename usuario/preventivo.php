		  ...
		  <tbody>
		  	...
		  	while ($row = mysqli_fetch_array($resultado_reg)) { 
				...
				$ciudad = $ruw['ciudad'];
			      ...
			      <td>			      	
			      	<a href="../historial/pdf_preventivo.php?idM= <?php echo $row['idmant_preventivo'] ?> " class="btn btn-secondary" title="Generar PDF">
				      <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
				    </a>
				    <a href="../historial/ver_preventivo.php?mant= <?php echo $row['idmant_preventivo'] ?> " class="btn btn-info" title="Ver Registro">
			      		<i class="fa fa-eye" aria-hidden="true"></i>
			      	</a>
			      	<a href="#" onclick="borrarPreventivo(<?php echo $row['idmant_preventivo']?>)" class="btn btn-danger" title="Borra Registro">
