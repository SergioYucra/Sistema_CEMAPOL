	 	...
	 	<table id="datatable" class="table table-hover table-condensed table-bordered">
		  ...
		  <tbody>
		  	...
		  	while ($row = mysqli_fetch_array($resultado_reg)) { 
			      ...
			      <td>			      	
			      	<a href="pdf_diagnostico.php?idD= <?php echo $idD; ?> " class="btn btn-secondary" title="Generar PDF">
				      <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
				    </a>
				    <a href="ver_diagnostico.php?idD= <?php echo $idD; ?> " class="btn btn-info" title="Ver Registro">
