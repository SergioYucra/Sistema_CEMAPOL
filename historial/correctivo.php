		  ...
		  <tbody>
		  	...
		  	while ($row = mysqli_fetch_array($resultado_reg)) { 
				...
				?>
			      ...
			      <td>
			      	<a href="pdf_correctivo.php?idM= <?php echo $row['idmant_correctivo'] ?> " class="btn btn-secondary" title="Generar PDF">
				      <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
				    </a>
				    <a href="ver_correctivo.php?mant= <?php echo $row['idmant_correctivo'] ?> " class="btn btn-info" title="Ver Registro">
